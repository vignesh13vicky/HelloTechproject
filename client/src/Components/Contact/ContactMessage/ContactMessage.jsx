...
const ContactMessage = () => {
  const initialData = { name: "", mobile: "", email: "", date: "", message: "" };
  ...
  return (
    <div className="container mb-5">
      <div className="booking-section d-flex align-items-center justify-content-center">
        <div className="container d-flex flex-column flex-md-row align-items-center justify-content-between h-100 py-5"
          ...
          <div className="row g-3 align-items-center">
            ...
            <div className="col-md-6">
              ...
              <p className="lead">
              Booking a tour is an exciting way to explore new destinations and create memorable experiences. Simply enter your name, mobile number, desired location, travel dates, and any specific request you have in mind. The platform will present you with a list of available tours, complete with detailed information about the itinerary, accommodations, transportation, and pricing.              </p>
            </div>
